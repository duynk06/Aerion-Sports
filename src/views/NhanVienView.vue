    ...
    <div v-if="!isDetailMode && !isFormMode">
      <div class="search-filter-box no-print"
        ...
        <div class="filter-header"
          style="background-color: #f17236; color: #fff; padding: 10px 15px; font-weight: bold; font-size: 15px; display: flex; align-items: center; gap: 8px;">
        ...
        <table style="width: 100%; border-collapse: separate; border-spacing: 0; text-align: left; font-size: 13px;">
          <thead>
            <tr>
              ...
              <th scope="col" style="padding: 12px 10px; width: 7%; font-weight: 600; background-color: #f17236; color: white;">Giới tính</th>
              <th scope="col" style="padding: 12px 10px; width: 9%; font-weight: 600; background-color: #f17236; color: white;">Ngày sinh</th>
              <th scope="col" style="padding: 12px 10px; width: 10%; font-weight: 600; background-color: #f17236; color: white;">Số điện thoại</th>
              <th scope="col" style="padding: 12px 10px; width: 14%; font-weight: 600; background-color: #f17236; color: white;">Email</th>
              <th scope="col" style="padding: 12px 10px; width: 15%; font-weight: 600; background-color: #f17236; color: white;">Địa chỉ</th>
              <th scope="col" style="padding: 12px 10px; width: 10%; font-weight: 600; background-color: #f17236; color: white;">Trạng thái</th>
              <th scope="col" style="padding: 12px 10px; width: 13%; font-weight: 600; text-align: center; background-color: #f17236; color: white; border-top-right-radius: 4px; border-bottom-right-radius: 4px;" class="no-print">Thao tác</th>
            </tr>
          </thead>
          <tbody>
            ...
            <div v-for="(addr, idx) in nhanVienForm.addresses" :key="idx" class="address-item-box mb-3 p-3"
              ...
              <div class="form-row">
                <div class="form-cell">
                  ...
                  <select v-model="addr.tinhThanh" class="form-select-control" required>
      ...
      <div class="custom-modal-container">
        ...
        <div class="custom-modal-body">
          ...
          <div class="modal-body-right">
            <div class="section-badge-title">
              <span class="icon-small">📝</span> Thêm nhanh địa chỉ
            </div>
            ...
            <div class="modal-form-checkbox">
              <label style="cursor: pointer; display: flex; align-items: center; gap: 6px; font-size: 13px;">
                <input type="checkbox" v-model="newAddress.isDefault" /> Đặt làm địa chỉ mặc định
              </label>
            </div>
...
const submitEditForm = async () => {
  try {
    if (!nhanVienForm.value.tenNv || !nhanVienForm.value.sdt || !nhanVienForm.value.email) {
      alert('Vui lòng điền đầy đủ các thông tin bắt buộc như Họ tên, SĐT, Email!')
      return
    }
