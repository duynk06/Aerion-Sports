        ...
        <div class="create-form-panel">
          <form class="create-form" @submit.prevent="$emit('save')">
            <div class="create-field">
              <label for="edit-code">Mã đợt giảm giá</label>
              <input id="edit-code" type="text" :value="form.maDotGiamGia || '-'" readonly />
            </div>

            <div class="create-field">
              <label for="edit-name">Tên đợt giảm giá</label>
              <input
                id="edit-name"
            ...
            <div class="create-field">
              <label for="edit-value">Giá trị (%)</label>
              <input
                id="edit-value"
            ...
            <div class="create-field">
              <label for="edit-note">Mô tả</label>
              <textarea
                id="edit-note"
