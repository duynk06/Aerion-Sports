        ...
        public SecurityFilterChain filterChain(HttpSecurity httpSecurity) throws Exception {
            httpSecurity
                    ...
                    .authorizeHttpRequests(auth -> auth
                            ...
                            // Mở khóa danh mục xem sản phẩm public cho Client
                            ...
                            // 🔐 PHÂN QUYỀN BẢO MẬT THẬT CHUẨN DOANH NGHIỆP

                            // Phân hệ báo cáo tài chính tối cao
                            .requestMatchers("/api/thong-ke/**").hasAnyRole("ADMIN", "QL")

                            // Nội bộ quầy POS bán hàng cơ sở
                            ...
                            // Quản lý biến thể & thuộc tính sản phẩm
                            ...
                            // Phân hệ nhân sự chỉ ADMIN độc quyền điều hành
                            .requestMatchers("/nhan-vien/**").hasRole("ADMIN")

                            // Các request còn lại bắt buộc có Token
